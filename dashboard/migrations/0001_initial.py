# Generated by Django 3.2.4 on 2021-10-10 09:32
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('product_margin', models.FloatField(blank=True, null=True)),
                ('gst', models.FloatField(blank=True, null=True)),
                ('gsm_type', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='dashboard.gsmtype')),
            ],
        ),
        migrations.CreateModel(
            name='Cupon',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('prodcut', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='dashboard.variableproduct')),
            ],
        ),
    ]
